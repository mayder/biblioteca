...
class AutorController extends Controller
{
            ...
            */
            ...
            if ($request->isGet) {
                ...
                return [
                    ...
                    'title' => Yii::t('yii2-ajaxcrud', 'Create New') . " Autor",
                    'content' => '<span class="text-success">' . Yii::t('yii2-ajaxcrud', 'Create') . ' Autor ' . Yii::t('yii2-ajaxcrud', 'Success') . '</span>',
                    'footer' =>  Html::button(Yii::t('yii2-ajaxcrud', 'Close'), ['class' => 'btn btn-default pull-left', 'data-bs-dismiss' => 'modal']) .
    ...
    public function actionUpdate($id)
    {
        ...
        if ($request->isAjax) {
            ...
            */
            ...
            if ($request->isGet) {
                return [
                    'title' => Yii::t('yii2-ajaxcrud', 'Update') . " Autor #" . $id,
    ...
    /**
     * Delete an existing Autor model.
     * For ajax request will return json object
    ...
    /**
     * Delete multiple existing Autor model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param integer $id
     * @return mixed
