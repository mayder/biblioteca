...
/* @var $searchModel app\models\AssuntoSearch */
...
<div class="container-fluid py-3 assunto-index">
                    ...
                    'toolbar' => [
                        [
                            ...
                            Html::a(
                                ...
                                ['create'],
                                ['role' => 'modal-remote', 'title' => Yii::t('yii2-ajaxcrud', 'Create New') . ' Assuntos', 'class' => 'btn btn-outline-primary']
                            ) .
                                Html::a(
